...
import weloveclouds.ecs.configuration.providers.WebServiceConfigurationProvider;
...
public class WebServiceModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(String.class).annotatedWith(JerseyResourcesConfigClass.class)
                .toInstance(WebServiceConfigurationProvider.getJerseyResourcesConfigClass());
    }
}
