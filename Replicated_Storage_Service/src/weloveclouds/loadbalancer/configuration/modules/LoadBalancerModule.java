...
public class LoadBalancerModule extends AbstractModule {
    ...
    @Provides
    public IMessageSerializer<SerializedMessage, IKVMessage> getClientMessageSerializer() {
        return new KVMessageSerializer();
    }

    @Provides
    public IMessageDeserializer<IKVMessage, SerializedMessage> getClientMessageDeserializer() {
        return new KVMessageDeserializer();
    }

    @Provides
    public IMessageSerializer<SerializedMessage, IKVAdminMessage> getAdminMessageSerializer() {
        return new KVAdminMessageSerializer();
    }

    @Provides
    public IMessageDeserializer<IKVAdminMessage, SerializedMessage> getAdminMessageDeserializer() {
    ...
    protected void configure() {
        ...
        bind(Integer.class).annotatedWith(CacheMaximalCapacity.class)
                .toInstance(LoadBalancerConfigurationProvider.getCacheMaximalCapacity());
