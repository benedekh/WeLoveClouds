...
public class HelpMessageGenerator {
    ...
    public static String generateHelpMessage() {
        ...
        buffer.append(CustomStringJoiner.join("","Second, the user shall set on which port should the server be available to the KVClients. Default value is: ", String.valueOf(KVServerPortConstants.KVCLIENT_REQUESTS_PORT) ,"\n"));
        buffer.append(CustomStringJoiner.join("","Third, the user shall set on which port should the server be available to the KVCServers. Default value is: ", String.valueOf(KVServerPortConstants.KVSERVER_REQUESTS_PORT) ,"\n"));
        buffer.append(CustomStringJoiner.join("","Fourth, the user shall set on which port should the server be available to the KVECS. Default value is: ", String.valueOf(KVServerPortConstants.KVECS_REQUESTS_PORT) ,"\n"));
